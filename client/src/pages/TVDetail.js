...
import { api, poster, backdrop, whereToWatchLinks } from '../utils/api';
...
export default function TVDetail() {
  ...
  const wtw = whereToWatchLinks(data.name);
      ...
      <div className="detail-main container">
        ...
        <div className="detail-info fade-up">
          ...
          <div className="detail-actions">
            {/* Plays trailer + shows where to watch */}
            <Link to={`/play/tv/${data.id}/1/1`} className="btn-primary">
              ▷ &nbsp; Play Trailer
            </Link>
          </div>
              ...
              <div className="episodes-list">
                {episodes.map(ep => (
                  <Link
                    ...
                    to={`/play/tv/${data.id}/${selectedSeason}/${ep.episode_number}`}
